...
public class Login {
	...
	private void initialize() {
		...
		frmLogin.setIconImage(Toolkit.getDefaultToolkit().getImage(Login.class.getResource("/images/multimediavideoplayer_128px.png")));
		...
		AppVideoLetters.setIcon(new ImageIcon(Login.class.getResource("/images/AppVideo-letra.png")));
		...
		AppVideoIcon.setIcon(new ImageIcon(Login.class.getResource("/images/multimediavideoplayer_128px.png")));
		...
		UserIcon.setIcon(new ImageIcon(Login.class.getResource("/images/UserIcon.png")));
		...
		textPassword.setBorder(new MatteBorder(1, 1, 1, 1, (Color) new Color(0, 0, 0)));
		textPassword.setForeground(SystemColor.windowBorder);
		textPassword.setBackground(new Color(255, 255, 255));
		textPassword.setHorizontalAlignment(SwingConstants.CENTER);
		textPassword.setFont(new Font("Gill Sans MT", Font.BOLD, 16));
		textPassword.setPreferredSize(new Dimension(7, 40));
		...
		btnNewButton.setSize(new Dimension(48, 48));
		btnNewButton.setBorderPainted(false);
		btnNewButton.setBackground(Color.WHITE);
		btnNewButton.setIcon(new ImageIcon(Login.class.getResource("/images/join_enter_login_icon.png")));
		...
		btnNewButton_1.setFont(new Font("Gill Sans MT", Font.BOLD, 14));
		btnNewButton_1.setIcon(new ImageIcon(Login.class.getResource("/images/RegisterIcon.png")));
		...
		ImageLoginInterface.setIcon(new ImageIcon(Login.class.getResource("/images/LoginFrameFont.jpg")));
		//panel_1.add(ImageLoginInterface);
